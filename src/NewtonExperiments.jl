...
export N, raiz, NewtonBasin, flagging_roots, color_list , color_list2, cores_joao # uma vez que eu chamar using ExemploJoao, N aparece sem ter que escrever ExemploJoao.N
